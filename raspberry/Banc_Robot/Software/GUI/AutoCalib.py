...
def AutoCalib(self):
    ...
    Popup(self, 1, texte= "Assurez vous que tous les capteurs sont branchés et appuyer sur 'Continuer'", fermer= 'Continuer')
    ...
    #Détermination des min et max capteur position
